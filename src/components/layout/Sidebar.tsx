...
import { SidebarOpen, SidebarClose, ChevronDown, ChevronUp, MoreVertical, FilePlus2, Plus } from "lucide-react";
      ...
      <ScrollArea className="flex-1">
        <div className="p-2">
          ...
          <div className="space-y-1">
            ...
            <Collapsible open={isPrototypeOpen && !collapsed} onOpenChange={setIsPrototypeOpen}>
              <CollapsibleContent>
